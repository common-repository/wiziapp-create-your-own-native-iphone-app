<?php
	...
	class WiziappPluginSettings
	{
		...
		/**
		 * Get Android Homescreen icon status
		 *
		 * @since 4.1.4
		 *
		 */
		function getAndroidHomescreen()
		{
			$this->_load();
			return $this->options['android']['homescreen'];
		}
		
		/**
		 * Set Android Homescreen icon status
		 *
		 * @since 4.1.4
		 *
		 */
		function setAndroidHomescreen($homescreen)
		{
			$this->_load();
			$this->options['android']['homescreen'] = $homescreen;
			$this->_save();
		}
