<?php
	...
	class WiziappPluginModuleCompatibility
	{
		function init()
		{
			...
			add_filter( 'rocket_cache_reject_ua', array( $this, 'cached_mobile_browsers' ) );
			...
			wiziapp_plugin_hook()->hookInstall( array( $this, 'installWPRocket' ) );
			wiziapp_plugin_hook()->hookUninstall( array( $this, 'uninstallWPRocket' ) );
		}
		...
		public function installWPRocket() {
			if ( function_exists( 'flush_rocket_htaccess' ) ) {
				flush_rocket_htaccess();
			}
		}

		public function uninstallWPRocket() {
			if ( function_exists( 'flush_rocket_htaccess' ) ) {
				remove_filter( 'rocket_cache_reject_ua', array( $this, 'cached_mobile_browsers' ) );
				flush_rocket_htaccess();
			}
		}
	}
