(function($,w,d){
	$(function() {
		...
		$("#wiziapp-plugin-admin-settings-box-general [data-wiziapp-plugin-admin-option-id='android_active']").hide();
		$("#wiziapp-plugin-admin-settings-box-general [data-wiziapp-plugin-admin-option-id='ios_active']").hide();
		
		$( document ).one( 'wizi_license_ios_ajax_ready', function() {
			var ios = $("#wiziapp-plugin-admin-settings-box-general [data-wiziapp-plugin-admin-option-id='ios_active']");
			if ( ! ios.hasClass('wizi-has-bundle') ) {
				ios.show();
			}
		} );

		$( document ).one( 'wizi_license_android_ajax_ready', function() {
			var android = $("#wiziapp-plugin-admin-settings-box-general [data-wiziapp-plugin-admin-option-id='android_active']");
			if ( ! android.hasClass('wizi-has-bundle') ) {
				android.show();
			}
		} );

		$( document ).one( 'wizi_license_has_bundle_ajax_ready', function() {
			var ios = $("#wiziapp-plugin-admin-settings-box-general [data-wiziapp-plugin-admin-option-id='ios_active']").addClass('wizi-has-bundle');
			var android = $("#wiziapp-plugin-admin-settings-box-general [data-wiziapp-plugin-admin-option-id='android_active']").addClass('wizi-has-bundle');
		...
		$("#wiziapp-plugin-admin-settings-box-android-body-buy").each(function() {
			var a = $(this).find(".wiziapp-plugin-admin-state-buy-billing-simulate:not(.wiziapp-plugin-admin-state-buy-billing-simulate-device) a");
...
//////Android
		...
		// Hide tabs
		$( '#wiziapp-plugin-admin-tab-header-themes, #wiziapp-plugin-admin-tab-header-plugins').hide();
		// Hide the default boxes
        $('#wiziapp-plugin-admin-settings-box-themes, #wiziapp-plugin-admin-settings-box-general, #wiziapp-plugin-admin-settings-box-monetization-body-buy, #wiziapp-plugin-admin-settings-box-monetization-body-buy, #wiziapp-plugin-admin-settings-box-monetization' ).hide();
			...
			action: "wiziapp_plugin_bundle_license_expiration"
				...
				if (data && data.expiration !== 'false') {
					$('#wiziapp-plugin-admin-settings-box-bundle').show();
					$('#wiziapp-plugin-admin-settings-box-ios').show();

                    $('#wiziapp-plugin-admin-settings-box-themes, #wiziapp-plugin-admin-settings-box-general, #wiziapp-plugin-admin-settings-box-monetization-body-buy, #wiziapp-plugin-admin-settings-box-monetization-body-buy, #wiziapp-plugin-admin-settings-box-monetization' ).show();
									...
									$( document ).trigger( 'wizi_license_has_bundle_ajax_ready' );
				}
				else {
			...
			post_ajax({
				...
				if (data && data.expiration !== 'false') {
                                    ...
                                    $("#wiziapp-plugin-admin-settings-box-android-body").addClass("wiziapp-plugin-admin-settings-box-body-active");
                                     ...
                                     $('#wiziapp-plugin-admin-settings-box-monetization-body-buy').hide();
				}
				else {
                                    if(data.Expendable !== true){
					...
					$( document ).trigger( 'wizi_license_android_ajax_ready' );
				}
			});
		}
...
// expand
			...
			post_ajax({
				action: "wiziapp_plugin_build_ios_license_balance"
					...
					//$("#wiziapp-plugin-admin-settings-box-ios-body-available").addClass("wiziapp-plugin-admin-settings-box-body-active");
								...
								$( document ).trigger( 'wizi_license_ios_ajax_ready' );
                            }
		...
		post_ajax({
			...
			if (data && data.expiration !== 'false' ) {
                ...
                $('#wiziapp-plugin-admin-settings-box-themes, #wiziapp-plugin-admin-settings-box-general, #wiziapp-plugin-admin-settings-box-monetization-body-buy, #wiziapp-plugin-admin-settings-box-monetization' ).show();
                $("#wiziapp-plugin-admin-settings-box-monetization-body-buy").hide();
			}
		});
